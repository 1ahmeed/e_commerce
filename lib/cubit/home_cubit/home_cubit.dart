...
import 'package:e_commerce/models/order_details/order_details_model.dart';
...
class HomeCubit extends Cubit<HomeState> {
  ...
  Future<void>  addOrRemoveFromFavourite({required productId}) async {
  ...
  Future<void>  deleteAddresses({required int addressId}) async {
